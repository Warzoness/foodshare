    ...
    <div className={styles.wrap}>
      <div className="page-container pt-3 pb-2">
        ...
        <footer className={styles.footer}>
          <div className={styles.footerTitle}>Thông tin công ty</div>
          <div className={styles.footerItem}>
            <span className={styles.footerLabel}>Tên công ty:</span>
          ...
          <div className={styles.footerItem}>
            <span className={styles.footerLabel}>Điện thoại:</span>
            <a href="tel:0369454687" style={{color: 'inherit', textDecoration: 'none'}}>0369454687</a>
          </div>
          <div className={styles.footerItem}>
          ...
          <div className={styles.footerItem}>
            ...
            <span>Thôn Nhân Hòa, Xã Thư Vũ, Tỉnh Hưng Yên, Việt Nam</span>
          </div>
        </footer>
      </div>
      <FloatMenu />
